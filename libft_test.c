...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/25 17:19:46 by jquintin          #+#    #+#             */
/*   Updated: 2022/10/28 18:30:12 by jquintin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../42_github/libft/libft.h"
#include <ctype.h>
#include <stdio.h>
#include <string.h>
#include <strings.h>
...
void	ft_strtrim_test(void)
{
	...
	char *s10 = " ab";
	char *s9p;
	s9p = ft_strtrim(s9, s10);
	printf("ft_  - s4: \"   abtest1ba   \" || set: \" ab\"   : %s\n\n", s9p);
	free (s9p);
}
